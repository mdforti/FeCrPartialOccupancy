...
\begin{figure}
  \fbox{ \includegraphics[width=0.45\textwidth, trim=0 0.5cm 1cm 1cm, clip]{Figure_GRACE_potential_prediction.pdf} }
  \fbox{ \includegraphics[width=0.45\textwidth, trim=0 0.5cm 1cm 1cm, clip]{Figure_ParityPlot.pdf}}
