...
\begin{abstract}
The Fe–Cr \textsigma-phase forms in alloys with about 45–50 at.\% Cr at intermediate temperatures and can strongly affect their mechanical performance. 
Atomistic studies usually assume full sublattice occupation, but experiments show that several Wyckoff sites are only partially occupied, creating many possible local atomic configurations.
This configurational complexity limits direct first-principles sampling and leaves open questions about how partial occupancy influences the elastic properties of the $\sigma$-phase.
